...
{
    public readonly List<DialogBox> Dialogs = [];
...
public class BorisConversation : Conversation
{
    public AnchorDialogueBoxes DialogueBoxes { get; set; }

    public SoundID Voiceline { get; private set; }

    public BorisConversation(IOwnAConversation interfaceOwner, ID id, DialogBox dialogBox) : base(interfaceOwner, id, dialogBox)
    {
        DialogueBoxes = new();
