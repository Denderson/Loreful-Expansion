...
namespace loremiscExpansion.Creatures.Scavs.Collector
{
    ...
    public class ScavCollectorCritob : Critob
    {
        ...
        public ScavCollectorCritob() : base(Enums.ScavCollector)
        {
            ...
            RegisterUnlock(KillScore.Configurable(1), Enums.ScavCollectorUnlock, MultiplayerUnlocks.SandboxUnlockID.Slugcat);
        }

        public override int ExpeditionScore() => 10;

        public override IEnumerable<string> WorldFileAliases() => new string[] { "scavCollector", "scavengerCollector" };
        public override CreatureTemplate CreateTemplate()
        {
            CreatureTemplate creatureTemplate = new CreatureFormula(CreatureTemplate.Type.Scavenger, Type, "ScavCollector")
            {
